...
SubownerBrowser::SubownerBrowser( QObject *parent )
        : Browser( ( QWidget* ) 0 )
{
    qDebug() << "[SUBOWNERBROWSER] Constructing";
...
void SubownerBrowser::urlHovered( const QString& url, const QString& title, const QString& text )
{
...
void SubownerBrowser::update( const QString& html )
{
...
{
    DataThread::updateSubownerBrowser( filter );
}

void SubownerBrowser::mousePressEvent( QMouseEvent* event )
{
...
void SubownerBrowser::contextMenu( QMouseEvent* event, const QString& id )
{
...
void SubownerBrowser::contextMenuEvent(QContextMenuEvent* event)
{
...
void SubownerBrowser::contextMenuItemTriggered( QAction* a )
{   
...
void SubownerBrowser::toggleSrTable( const QString& id )
{
...
void SubownerBrowser::toggleInfoHeader( const QString& id )
{
...
void SubownerBrowser::toggleTables()
{
    if ( mOpen )
    {
        emit closeAll();
